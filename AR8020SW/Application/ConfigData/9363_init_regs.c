...
extern uint8_t RF9363_RC_vhf_frq[40][5];
...
uint8_t RF9363_RC_vhf_frq[40][5]  __attribute__ ((aligned (4))) = // 
{
    {0x78, 0x00, 0x00, 0x00, 0x00},  // 600
    {0x79, 0x00, 0x00, 0x00, 0x00},  // 605
    {0x7A, 0x00, 0x00, 0x00, 0x00},  // 610
    {0x7B, 0x00, 0x00, 0x00, 0x00},  // 615
    {0x7C, 0x00, 0x00, 0x00, 0x00},  // 620
    {0x7D, 0x00, 0x00, 0x00, 0x00},  // 625
    {0x7E, 0x00, 0x00, 0x00, 0x00},  // 630
    {0x7F, 0x00, 0x00, 0x00, 0x00},  // 635
    {0x80, 0x00, 0x00, 0x00, 0x00},  // 640
    {0x81, 0x00, 0x00, 0x00, 0x00},  // 645
    {0x82, 0x00, 0x00, 0x00, 0x00},  // 650
    {0x83, 0x00, 0x00, 0x00, 0x00},  // 655
    {0x84, 0x00, 0x00, 0x00, 0x00},  // 660
    {0x85, 0x00, 0x00, 0x00, 0x00},  // 665
    {0x86, 0x00, 0x00, 0x00, 0x00},  // 670
    {0x87, 0x00, 0x00, 0x00, 0x00},  // 675
    {0x88, 0x00, 0x00, 0x00, 0x00},  // 680
    {0x89, 0x00, 0x00, 0x00, 0x00},  // 685
    {0x8A, 0x00, 0x00, 0x00, 0x00},  // 690
    {0x8B, 0x00, 0x00, 0x00, 0x00},  // 695
    {0x8C, 0x00, 0x00, 0x00, 0x00},  // 700
    {0x8D, 0x00, 0x00, 0x00, 0x00},  // 705
    {0x8E, 0x00, 0x00, 0x00, 0x00},  // 710
    {0x8F, 0x00, 0x00, 0x00, 0x00},  // 715
    {0x90, 0x00, 0x00, 0x00, 0x00},  // 720
    {0x91, 0x00, 0x00, 0x00, 0x00},  // 725
    {0x92, 0x00, 0x00, 0x00, 0x00},  // 730
    {0x93, 0x00, 0x00, 0x00, 0x00},  // 735
    {0x94, 0x00, 0x00, 0x00, 0x00},  // 740
    {0x95, 0x00, 0x00, 0x00, 0x00},  // 745
    {0x96, 0x00, 0x00, 0x00, 0x00},  // 750
    {0x97, 0x00, 0x00, 0x00, 0x00},  // 755
    {0x98, 0x00, 0x00, 0x00, 0x00},  // 760
    {0x99, 0x00, 0x00, 0x00, 0x00},  // 765
    {0x9A, 0x00, 0x00, 0x00, 0x00},  // 770
    {0x9B, 0x00, 0x00, 0x00, 0x00},  // 775
    {0x9C, 0x00, 0x00, 0x00, 0x00},  // 780
    {0x9D, 0x00, 0x00, 0x00, 0x00},  // 785
    {0x9E, 0x00, 0x00, 0x00, 0x00},  // 790
    {0x9F, 0x00, 0x00, 0x00, 0x00}   // 795
};


extern uint8_t RF9363_It_vhf_frq[20][5];

STRU_cfgNode RF9363_It_vhf_nodeInfo = {
    .nodeId       = RF_IT_BAND0_10M_FRQ_ID,
    .nodeElemCnt  = 20,
    .nodeDataSize = sizeof(RF9363_It_vhf_frq)
};

uint8_t RF9363_It_vhf_frq[20][5]  __attribute__ ((aligned (4))) =
{
    {0x78, 0x00, 0x00, 0x00, 0x00},  // 600
    {0x7A, 0x00, 0x00, 0x00, 0x00},  // 610
    {0x7C, 0x00, 0x00, 0x00, 0x00},  // 620
...
extern uint8_t RF9363_vhf_20M_sweep_frq[10][5];

STRU_cfgNode RF9363_vhf_sweep_20M_nodeInfo = 
{
...
uint8_t RF9363_vhf_20M_sweep_frq[10][5]  __attribute__ ((aligned (4))) =
{
    {0x79, 0x00, 0x00, 0x00, 0x00},  // 605
    {0x7D, 0x00, 0x00, 0x00, 0x00},  // 625
    {0x81, 0x00, 0x00, 0x00, 0x00},  // 645
